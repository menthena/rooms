System.register(['angular2/core', 'angular2/common', 'angular2/router', '../../directives/loading-indicator', '../../validators/UserValidators', '../../services/UserService', '../../services/AppService'], function(exports_1) {
    ...
    var core_1, common_1, router_1, loading_indicator_1, UserValidators_1, UserService_1, AppService_1;
    var Login;
    return {
        setters:[
            function (core_1_1) {
        ...
        execute: function() {
            Login = (function () {
                ...
                Login = __decorate([
                    ...
                    __metadata('design:paramtypes', [common_1.FormBuilder, router_1.Router, UserService_1.UserService, UserValidators_1.UserValidators, AppService_1.AppService])
                ], Login);
                return Login;
            })();
