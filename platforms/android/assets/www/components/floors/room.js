System.register(['angular2/core', 'rxjs/Observable', '../../services/ReservationService', '../design/edit-element', '../../directives/resizable', '../../directives/draggable', '../../directives/popover', '../../directives/place-element', '../reservation/reservation-modal', '../../services/FloorElementsService', '../../services/DesignService'], function(exports_1) {
    ...
    var core_1, Observable_1, ReservationService_1, edit_element_1, resizable_1, draggable_1, popover_1, place_element_1, reservation_modal_1, FloorElementsService_1, DesignService_1;
    var Room;
    return {
        setters:[
            function (core_1_1) {
            ...
            Room = (function () {
                ...
                Room.prototype.checkAvailability = function () {
                    ...
                    if (!this.designMode && this.filter) {
                        Observable_1.Observable.fromArray(this.reservations)
                            .filter(function (res) {
